...
public class PlayerService {
    ...
    public void updateTurnStatus(Player p, boolean turn) {
         playerRepository.updateTurn(p,turn);
    }

    public boolean getPlayerTurnStatus(Player p) {
        return playerRepository.getTurn(p);
    }
